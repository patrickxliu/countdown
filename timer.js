...
const startDate = new Date(2024, 5, 23, 8, 19, 0).getTime();// initial date and time the countdown clock started from (Year, Month, Day, Hours, Minutes, Seconds,)
...
function photos (){
	window.location.assign("https://photos.app.goo.gl/jcaTGoSDiGEZGVdD9");
}
